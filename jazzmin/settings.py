...
DEFAULT_SETTINGS: Dict[str, Any] = {
    ...
    "icons": {"auth": "mdi mdi-settings", "auth.user": "mdi mdi-account", "auth.Group": "mdi mdi-account-multiple"},
    # Icons that are used when one is not manually specified
    "default_icon_parents": "mdi mdi-menu-right",
    "default_icon_children": "mdi mdi-brightness-1",
    #################
    # Related Modal #
    #################
